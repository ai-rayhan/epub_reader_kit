...
interface BooksDao {
    ...
    @Query("SELECT " + Book.ID + " FROM " + Book.TABLE_NAME + " ORDER BY " + Book.CREATION_DATE + " DESC LIMIT 1")
    suspend fun getLatestBookId(): Long?

    @Query("SELECT " + Book.ID + " FROM " + Book.TABLE_NAME + " WHERE " + Book.IDENTIFIER + " = :identifier LIMIT 1")
