...
class MediaService : MediaSessionService() {
    ...
    inner class Binder : android.os.Binder() {
        ...
        private val app: com.example.epub_reader_kit.reader.EpubReaderKitApp
            get() = application as com.example.epub_reader_kit.reader.EpubReaderKitApp
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val readerRepository = (application as com.example.epub_reader_kit.reader.EpubReaderKitApp).readerRepository
    ...
    companion object {
        ...
        const val SERVICE_INTERFACE = "com.example.epub_reader_kit.reader.reader.MediaService"

        fun start(application: EpubReaderKitApp) {
            val intent = intent(application)
            application.startService(intent)
        }

        fun stop(application: EpubReaderKitApp) {
            val intent = intent(application)
