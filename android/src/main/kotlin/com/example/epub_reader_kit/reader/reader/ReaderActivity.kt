...
import com.example.epub_reader_kit.reader.databinding.ActivityReaderBinding
import com.example.epub_reader_kit.reader.outline.OutlineContract
import com.example.epub_reader_kit.reader.outline.OutlineFragment
import com.example.epub_reader_kit.reader.utils.launchWebBrowser
...
open class ReaderActivity : AppCompatActivity() {
    ...
    override val defaultViewModelProviderFactory: ViewModelProvider.Factory
        get() = ReaderViewModel.createFactory(
            application as EpubReaderKitApp,
    ...
    private fun createReaderFragment(readerData: ReaderInitData): BaseReaderFragment? {
        val readerClass: Class<out Fragment>? = when (readerData) {
            ...
            is ImageReaderInitData -> com.example.epub_reader_kit.reader.reader.ImageReaderFragment::class.java
...
/*
    ...
    private fun reconfigureActionBar() {
        ...
        supportActionBar?.apply {
            val showForOutline = currentFragment is OutlineFragment
            if (showForOutline) {
                show()
