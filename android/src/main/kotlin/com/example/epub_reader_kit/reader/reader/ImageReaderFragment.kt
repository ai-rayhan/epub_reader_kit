...
class ImageReaderFragment : com.example.epub_reader_kit.reader.reader.VisualReaderFragment() {

    override lateinit var navigator: Navigator

    override fun onCreate(savedInstanceState: Bundle?) {
        val readerData = model.readerInitData as? com.example.epub_reader_kit.reader.reader.VisualReaderInitData ?: run {
        ...
        if (savedInstanceState == null) {
            childFragmentManager.commitNow {
                add(
                    ...
                    Bundle(),
                    com.example.epub_reader_kit.reader.reader.ImageReaderFragment.Companion.NAVIGATOR_FRAGMENT_TAG
                )
            }
        }
        navigator = childFragmentManager.findFragmentByTag(com.example.epub_reader_kit.reader.reader.ImageReaderFragment.Companion.NAVIGATOR_FRAGMENT_TAG)!! as Navigator
        return view
    }
